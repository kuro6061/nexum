"""
demo.py  EAutoGen AssistantAgent with durable Nexum tool execution.
...
Environment variables:
    GEMINI_API_KEY    EGoogle Gemini API key (default model)
    OPENAI_API_KEY    EOpenAI API key (optional)
    ANTHROPIC_API_KEY  EAnthropic API key (optional)
    NEXUM_MODEL       Eoverride model (default: gemini/gemini-2.5-flash-preview-04-17)
"""
